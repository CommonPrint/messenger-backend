package result.server.messengerbackend.infrastructure.secondary.entity;
...
import result.server.messengerbackend.messaging.domain.user.vo.UserFirstname;
import result.server.messengerbackend.messaging.domain.user.vo.UserImageUrl;
import result.server.messengerbackend.messaging.domain.user.vo.UserLastName;
import result.server.messengerbackend.messaging.domain.user.vo.UserPublicId;
import result.server.messengerbackend.shared.jpa.AbstractAuditingEntity;
